<script lang="ts">
    ...
    const navItems: NavItem[] = [
        ...
        */
        ...
        // ❌ ADMIN (auskommentiert)
        /*
        {
            label: $t('app.layout.admin'),
            subMenu: [
                { href: '/dashboard/admin/jobs', label: $t('app.jobs.jobs') },
                { href: '/dashboard/settings/users', label: $t('app.layout.users') },
                { href: '/dashboard/settings/roles', label: $t('app.layout.roles') },
            ],
            position: 4,
        },
        */

        // ❌ SETTINGS (auskommentiert)
        /*
        {
            label: $t('app.layout.settings'),
            subMenu: [
                { href: '/dashboard/settings/system', label: $t('app.layout.system') },
                { href: '/dashboard/settings/api-keys', label: $t('app.layout.api_keys') },
            ],
            position: 5,
        },
        */
